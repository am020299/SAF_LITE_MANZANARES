...
{
    public partial class xfrm_devolucionesProductoDañado : DevExpress.XtraEditors.XtraForm
    {
        public xfrm_devolucionesProductoDañado()
        {
            InitializeComponent();
        }
        ...
        {
            srch_facturas.Properties.DataSource = Negocio.ClasesCN.VentasCN.Ventas_SELECT_DevolucionesProductoDañado(1).Where(o => o.activo == true && o.estado == 2 && o.moneda == 2 && o.dias == 0);
