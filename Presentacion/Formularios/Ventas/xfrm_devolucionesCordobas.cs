...
{
    public partial class xfrm_devolucionesCordobas : DevExpress.XtraEditors.XtraForm
    {
        public xfrm_devolucionesCordobas()
        {
            InitializeComponent();
        }
        ...
        {
            srch_facturas.Properties.DataSource = Negocio.ClasesCN.VentasCN.Ventas_Select_Devoluciones(1).Where(o => o.activo == true && o.estado == 2 && o.moneda == 1 && o.dias == 0);
