...
{
    public partial class xfrmListaPreciosCordoba : DevExpress.XtraEditors.XtraForm
    {
        public xfrmListaPreciosCordoba()
        {
            InitializeComponent();
        ...
        {
            bindingSourceProducto.DataSource = Negocio.ClasesCN.CatalogosCN.Producto_Cargar_Cordobas();
