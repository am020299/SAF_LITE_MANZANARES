...
{
    public partial class XtraReportTrasnferencias : DevExpress.XtraReports.UI.XtraReport
    {
        bool ventana;
        ...
        DateTime fechaHasta;
        int tipo;
        public XtraReportTrasnferencias(BindingSource source, DateTime fecha, int tipo)
        {
            InitializeComponent();
        ...
        public XtraReportTrasnferencias(BindingSource source, DateTime fechaDesde, DateTime fechaHasta)
        {
            InitializeComponent();
            this.DataSource = source;
