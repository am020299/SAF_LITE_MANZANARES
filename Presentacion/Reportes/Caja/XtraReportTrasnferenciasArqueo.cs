...
{
    public partial class XtraReportTrasnferenciasArqueo : DevExpress.XtraReports.UI.XtraReport
    {
        bool ventana;
        ...
        DateTime fechaHasta;
        int tipo;
        public XtraReportTrasnferenciasArqueo(BindingSource source, DateTime fecha, int tipo)
        {
            InitializeComponent();
        ...
        public XtraReportTrasnferenciasArqueo(BindingSource source, DateTime fechaDesde, DateTime fechaHasta)
        {
            InitializeComponent();
            this.DataSource = source;
        ...
        private void XtraReportTrasnferencias_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (ventana)
            {
                ...
                {
                    xrLabel1.Text = "REPORTE DE TRANSFERENCIAS";
                    this.DataSource = Negocio.ClasesCN.CajaCN.TRANSFERENCIA_rango_SELECT(fechaTRF, fechaHasta, 1);
                ...
                {
                    xrLabel1.Text = "REPORTE DE TRANSFERENCIAS";
                    this.DataSource = Negocio.ClasesCN.CajaCN.TRANSFERENCIA_rango_SELECT(fechaTRF, fechaHasta, 2);
                    //xrTableCell6.Visible = false;
                    //xrtablecellTIPO.Visible = false;
                }
                else
                {
                    ...
                    this.DataSource = Negocio.ClasesCN.CajaCN.TRANSFERENCIA_rango_SELECT(fechaTRF, fechaHasta, 0);
