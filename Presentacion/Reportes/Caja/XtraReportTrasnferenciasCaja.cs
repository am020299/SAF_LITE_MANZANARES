...
{
    public partial class XtraReportTrasnferenciasCaja : DevExpress.XtraReports.UI.XtraReport
    {
        bool ventana;
        ...
        DateTime fechaHasta;
        int tipo;
        public XtraReportTrasnferenciasCaja(BindingSource source, DateTime fecha, int tipo)
        {
            InitializeComponent();
        ...
        public XtraReportTrasnferenciasCaja(BindingSource source, DateTime fechaDesde, DateTime fechaHasta)
        {
            InitializeComponent();
            this.DataSource = source;
