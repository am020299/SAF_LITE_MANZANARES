...
{
    public partial class xrpt_cliente_frecuentes : DevExpress.XtraReports.UI.XtraReport
    {
        DateTime fechaIni, fechaFin;
        public xrpt_cliente_frecuentes(DateTime vFechaInicio, DateTime vFechaFinal)
        {
            InitializeComponent();
