...
{
    public sealed class numeros_a_letras
    {
        ...
        public numeros_a_letras(Boolean ConvertirDecimales,String MascaraSalidaDecimal,String SeparadorDecimalSalida,Boolean LetraCapital)
        {
        ...
        {
            return numeros_a_letras.ToCardinal(Numero,CultureInfo.CurrentCulture);
        }
